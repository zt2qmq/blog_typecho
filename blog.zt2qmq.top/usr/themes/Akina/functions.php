...
//博客信息
    $QQ = new Typecho_Widget_Helper_Form_Element_Text('QQ', NULL,'854972252', _t('QQ号码'), _t('作为全局博主头像'));
    $form->addInput($QQ);
    ...
    $ICP = new Typecho_Widget_Helper_Form_Element_Text('ICP', NULL,'', _t('备案号'), _t('备案号（默认内容"Carpe Diem and Do what I like"）'));
    $form->addInput($ICP);
	
//个人信息
    //新浪
    $SINA = new Typecho_Widget_Helper_Form_Element_Text('SINA', NULL,'https://www.weibo.com/u/6476505572/home', _t('新浪微博地址'), _t('默认新浪微博首页（请规范填写，需https://，http://或者//）'));
    $form->addInput($SINA);
    //微信
    $Wechat = new Typecho_Widget_Helper_Form_Element_Text('Wechat', NULL,'zt2qmq', _t('微信号'), _t('首页个人信息'));
    $form->addInput($Wechat);
    //QQ
    $QQnum = new Typecho_Widget_Helper_Form_Element_Text('QQnum', NULL,'854972252', _t('QQ信息'), _t('首页个人信息'));
    $form->addInput($QQnum);
    //QQ空间
    $Qzone = new Typecho_Widget_Helper_Form_Element_Text('Qzone', NULL,'https://user.qzone.qq.com/854972252', _t('QQ空间信息'), _t('首页个人QQ空间信息:https://user.qzone.qq.com/QQ号码'));
    $form->addInput($Qzone);
    //Github
    $Github = new Typecho_Widget_Helper_Form_Element_Text('Github', NULL,'https://github.com/zt2qmq', _t('Github地址'), _t('Github主页地址（请规范填写，需https://，http://或者//）'));
...
//文章推荐
    ...
    $feature1 = new Typecho_Widget_Helper_Form_Element_Text('feature1', NULL,'https://typecho.me/', _t('聚焦内容1'), _t('请规范填写，需https://，http://或者//'));
    $form->addInput($feature1);
	
    $feature2 = new Typecho_Widget_Helper_Form_Element_Text('feature2', NULL,'https://plugins.typecho.me/', _t('聚焦内容2'), _t('请规范填写，需https://，http://或者//'));
    $form->addInput($feature2);
	
    $feature3 = new Typecho_Widget_Helper_Form_Element_Text('feature3', NULL,'http://185.116.93.173:50001/zt2qmq', _t('聚焦内容3'), _t('请规范填写，需https://，http://或者//'));
